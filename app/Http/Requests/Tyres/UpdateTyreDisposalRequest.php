...
class UpdateTyreDisposalRequest extends FormRequest
{
    public function authorize(): bool
    {
        $disposal = $this->route('disposal');

        return $disposal instanceof TyreDisposal
            && ($this->user()?->can('update', $disposal) ?? false);
    }
