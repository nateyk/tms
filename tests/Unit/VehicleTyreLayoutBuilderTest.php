...
class VehicleTyreLayoutBuilderTest extends TestCase
{
    ...
    public function it_builds_twelve_tyre_trailer_layout(): void
    {
        ...
        $this->assertSame('A', $positions[0]['code']);
        $this->assertSame('A', $positions[0]['display_code']);
        $this->assertSame('T1', $positions[0]['legacy_code']);
    ...
    public function it_preserves_internal_position_codes_while_exposing_paper_labels(): void
    {
        ...
        $this->assertSame('A', $positions[0]['display_code']);
        $this->assertSame('P1', $positions[0]['legacy_code']);
        $this->assertSame('P11', $positions[10]['legacy_code']);
        ...
        $this->assertSame('P16', $positions[15]['legacy_code']);
        ...
        $this->assertSame('P24', $positions[23]['legacy_code']);
